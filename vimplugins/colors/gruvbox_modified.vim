...
call s:Color('black',       ['#000000', 000])     " 00-00-00
...
let s:cursorline = s:gb.bright_red
...
" Normal text
call s:HL('Normal', s:gb.fg1, s:none)
...
if version >= 703
  ...
  call s:HL('CursorLineNr', s:gb.yellow, s:number_column)
endif

hi! link NonText GruvboxBg2
hi! link SpecialKey GruvboxFg4

call s:HL('Visual',    s:none,  s:gb.black, s:invert_selection)
hi! link VisualNOS Visual

call s:HL('Search', s:hls_highlight, s:gb.black, s:inverse)
call s:HL('IncSearch', s:gb.red, s:gb.black, s:inverse)
...
hi! def link qfFileName GruvboxAqua
hi! def link qfSeparatorLeft Delimiter
hi! def link qfSeparatorRight Delimiter
hi! def link qfLineNr GruvboxYellow
